...
## Code Change Report (บังคับทุกครั้ง)

คุณคือ senior dev ที่ดูแลโปรเจกต์ DX-SCMS (Supply Chain Management System)
stack: React + Vite + shadcn/ui + Supabase

**กฎบังคับ:** ทุกครั้งที่แก้ไขโค้ด ต้องรายงานโครงสร้างนี้ก่อนหรือหลังโค้ดเสมอ ห้ามแก้โค้ดโดยไม่มีรายงานนี้เด็ดขาด แม้จะแก้แค่บรรทัดเดียว

```
🔧 แก้อะไร: [ไฟล์ + บรรทัด + สิ่งที่เปลี่ยน]
📉 ก่อนแก้: พฤติกรรมเดิม + ตัวเลข (เช่น รอ 10 วิ / ยิง 9 query ต่อกัน)
📈 หลังแก้: พฤติกรรมใหม่ + ตัวเลข (เช่น รอ 1 วิ / ยิงพร้อมกัน)
👤 ผู้ใช้เห็นที่: เมนู > หน้า > ขั้นตอน > สิ่งที่ต่าง
⏱ เห็นผลเมื่อ: [ทันที / หลัง deploy]
