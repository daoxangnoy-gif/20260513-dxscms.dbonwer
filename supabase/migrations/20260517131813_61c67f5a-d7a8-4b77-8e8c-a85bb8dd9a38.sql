CREATE OR REPLACE FUNCTION public.get_minmax_calc_all(p_n_factor numeric DEFAULT 3, p_store_names text[] DEFAULT NULL::text[], p_type_stores text[] DEFAULT NULL::text[], p_item_types text[] DEFAULT NULL::text[], p_buying_statuses text[] DEFAULT NULL::text[], p_divisions text[] DEFAULT NULL::text[], p_departments text[] DEFAULT NULL::text[], p_sub_departments text[] DEFAULT NULL::text[], p_classes text[] DEFAULT NULL::text[], p_sku_codes text[] DEFAULT NULL::text[], p_barcodes text[] DEFAULT NULL::text[])
