-- =====================================================================
-- Add 6 product hierarchy filter params to get_srr_data (DC)
-- =====================================================================
...
GRANT EXECUTE ON FUNCTION public.get_srr_data(text[],text[],text[],text[],text[],text[],text[],text[],text[],text[]) TO authenticated, anon;

-- =====================================================================
-- Add 6 hierarchy filter params to get_srr_d2s_data (DIRECT/per-store)
-- =====================================================================
DROP FUNCTION IF EXISTS public.get_srr_d2s_data(text[],text[],text[],text[]);
...
GRANT EXECUTE ON FUNCTION public.get_srr_d2s_data(text[],text[],text[],text[],text[],text[],text[],text[],text[],text[]) TO authenticated, anon;

-- =====================================================================
-- Helper RPC: returns distinct hierarchy combinations from data_master
-- so the UI can compute cascading filter dropdowns where each filter
-- narrows the others. Limited to the active product owner.
-- =====================================================================
...
GRANT EXECUTE ON FUNCTION public.get_srr_hierarchy_options() TO authenticated, anon;